...
class AIService:
    ...
    async def generate_event_response(self, user_message: str, user_preferences: Dict = None, conversation_history: List = None, plan_context: Dict = None) -> Dict[str, Any]:
        ...
        has_generated_content = plan_context and plan_context.get("generated_content") and plan_context["generated_content"].get("images")
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    if result.get("awaiting_confirmation") and not user_confirmed_generation:
                        # Check if user confirmed generation
                        if data_collection_service.detect_user_confirmation(user_message):
