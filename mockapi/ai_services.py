...
class AIService:
    ...
    async def generate_event_response(self, user_message: str, user_preferences: Dict = None, conversation_history: List = None, plan_context: Dict = None) -> Dict[str, Any]:
        ...
        # Get the data collection prompt from the dedicated service
        prompt = data_collection_service.get_data_collection_prompt()
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    analysis = data_collection_service.analyze_conversation_completeness(suggestions)
